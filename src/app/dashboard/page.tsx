    ...
    <div className="card">
      ...
      <div className="mt-6 space-y-2">
        {round1Status !== "COMPLETED" && round1SessionId && (
          ...
          >
            {getButtonText(round1Status)} Round 1
          </Link>
        )}
        {round1Status === "COMPLETED" && !round2Locked && round2SessionId && (
          <Link
            ...
            className="btn-primary block text-center w-full"
          >
            {getButtonText(round2Status)} Round 2
          </Link>
        )}
        {round2Locked && round1Status === "COMPLETED" && (
          <p className="text-sm text-muted text-center">
            Waiting for partner to complete Round 1
          </p>
        )}
      </div>
    </div>
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto p-6">
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Goal Setting Module</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <SessionCard
              ...
              round2Locked={!progress.bothRound1Complete}
          ...
          <div className="card">
            <div className="space-y-4">
              <div className="flex justify-between items-center py-3 border-b border-border">
                <div>
                  <h3 className="font-semibold">Discovery Document</h3>
                  <p className="text-sm text-muted">
                    {discoveryDoc
                      ? "Your shared goals and perspectives"
                      : "Available after both partners complete Round 1"}
                  </p>
                </div>
                {discoveryDoc ? (
              ...
              <div className="flex justify-between items-center py-3">
                <div>
                  ...
                  <p className="text-sm text-muted">
                    {finalSynthesis
                      ? "Your roadmap for shared goals"
                      : "Available after both partners complete Round 2"}
                  </p>
                </div>
                {finalSynthesis ? (
                  <div className="flex gap-2">
